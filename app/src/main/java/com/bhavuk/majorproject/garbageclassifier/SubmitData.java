...
public class SubmitData extends AppCompatActivity {
    ...
    private void signInAnonymously() {
        mAuth.signInAnonymously().addOnSuccessListener(this, new  OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                // do your stuff
                Toast.makeText(SubmitData.this, "Signed in Anonymously", Toast.LENGTH_LONG).show();
            }
        })
    ...
    private void upload_image(){
        ...
        data.setItemType("Organic");
        data.setOrganicProbability("50%");
        data.setRecycleProbability("50%");
